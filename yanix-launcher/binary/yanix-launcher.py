...
LANGUAGES = {
    ...
    "ja": {"welcome": "Yanix Launcherへようこそ", "loading": "読み込み中", "play": "プレイ", "github": "GitHub", "settings": "設定", "download": "ゲームをダウンロード", "select_language": "言語を選択", "select_exe": "WINE用の.exeを選択", "support": "サポート", "discord": "Discord", "lang_changed": "言語が変更されました！ランチャーを再起動してください。", "exit": "終了", "missing_path": "うーん、ホームフォルダに抽出してみてください", "select_background": "背景画像を選択", "winetricks": "Winetricks"},
    "zh": {"welcome": "欢迎使用 Yanix Launcher", "loading": "加载中", "play": "游戏", "github": "GitHub", "settings": "设置", "download": "下载游戏", "select_language": "选择语言", "select_exe": "选择 WINE 的 .exe 文件", "support": "支持", "discord": "Discord", "lang_changed": "语言已更改！请重新启动启动器。", "exit": "退出", "missing_path": "哎呀，请尝试将其解压到主文件夹", "select_background": "选择背景图片", "winetricks": "Winetricks"},
...
class YanixLauncher(QMainWindow):
    ...
    def setup_ui(self):
        ...
        add_button(self.lang["winetricks"], self.manage_winetricks)
        ...
        version = QLabel(f"{self.lang['welcome']} ucn version - expect issues!")
    ...
    def launch_game(self):
        if os.path.exists(CONFIG_PATH):
            ...
            if os.path.exists(path):
                ...
                return
        QMessageBox.critical(self, "Error", "437:Game failed to launch!")
